...
import { X, CheckCircle2, MessageCircle, Sparkles, Users, ShieldCheck, ArrowRight, ChevronRight, Car as CarIcon, Tag } from 'lucide-react';
...
export default function HiaceModal({ isOpen, onClose, onSelectVariantToBook }: HiaceModalProps) {
  ...
  const handleWhatsAppBooking = (variantName: string, priceDisplay?: string) => {
    ...
    const message = `Halo Araka Trans Travel (PT. Generasi Baru Araka), saya berminat memesan/sewa armada unit *${variantName}* (${priceDisplay || 'Mulai Tarif Resmi'}). Mohon info ketersediaan jam, tanggal & rincian sewa. Terima kasih!`;
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div>
                ...
                <p className="font-sans text-xs text-slate-300 font-medium mt-1">
                  Tersedia 4 kelas armada Toyota Hiace untuk menyesuaikan jumlah penumpang & kebutuhan Anda.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="border-b border-slate-100 pb-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="bg-amber-500 text-white font-sans font-extrabold text-sm px-4 py-2 rounded-xl shadow-md shrink-0 flex items-center gap-1.5">
