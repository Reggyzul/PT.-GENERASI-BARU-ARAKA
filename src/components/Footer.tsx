        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pt-16 pb-12">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <div className="text-xs text-slate-300 font-sans space-y-3">
              ...
              <div className="flex items-center gap-2.5">
                <Instagram className="w-4.5 h-4.5 text-teal-400 shrink-0" />
                <span>Instagram: <a href="https://instagram.com/Arakatrans_classytour" target="_blank" rel="noreferrer" className="text-teal-400 font-bold hover:underline">@Arakatrans_classytour</a></span>
              </div>

              <div className="flex items-center gap-2.5">
                <Facebook className="w-4.5 h-4.5 text-teal-400 shrink-0" />
                <span>Facebook: <a href="https://facebook.com/Arakatrans" target="_blank" rel="noreferrer" className="text-teal-400 font-bold hover:underline">@Arakatrans</a></span>
              </div>

              <p className="pt-2 text-slate-500 text-[11px]">©2026 PT. Generasi Baru Araka (Araka Trans Travel). Semua Hak Dilindungi.</p>
            </div>
          </div>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="bg-slate-800/90 p-4 rounded-2xl border border-slate-700 space-y-2.5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-[10px] text-slate-400 font-bold uppercase block">WhatsApp Fast Response</span>
            ...
            <div className="grid grid-cols-2 gap-3 pt-1">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="bg-slate-800/90 hover:bg-slate-800 p-3 rounded-2xl border border-slate-700 space-y-1 block transition-colors group cursor-pointer"
              >
