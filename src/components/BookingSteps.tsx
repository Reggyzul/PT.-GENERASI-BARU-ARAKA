    ...
    <section id="steps" className="py-20 bg-slate-50 overflow-hidden border-t border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <h2 className="font-display font-black text-3xl sm:text-4xl text-[#0c2340] tracking-tight uppercase">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-1/2 left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-[#0c2340] via-amber-500 to-[#1d4ed8] -translate-y-12 z-0 opacity-40" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            {stepsList.map((stepItem, index) => (
              <motion.div
                ...
                key={index}
                className="bg-white rounded-3xl p-6 sm:p-7 shadow-md border border-blue-900/20 hover:shadow-xl hover:border-amber-400 transition-all duration-300 flex flex-col items-center text-center relative group"
              >
                {/* Step Number Circle */}
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#0c2340] to-[#1d4ed8] text-amber-400 border-2 border-amber-400 flex items-center justify-center font-display font-black text-lg shadow-lg mb-5 group-hover:scale-110 transition-transform duration-300">
                  {stepItem.step}
                </div>
                
                <h3 className="font-display font-black text-lg text-[#0c2340] mb-2 group-hover:text-amber-500 transition-colors uppercase tracking-tight">
                  {stepItem.title}
                </h3>
