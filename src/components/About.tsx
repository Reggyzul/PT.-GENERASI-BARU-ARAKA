    ...
    <section id="about" className="py-20 sm:py-24 bg-gradient-to-b from-white via-slate-50 to-white text-[#0f172a] overflow-hidden relative border-b border-slate-200">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-14">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-2" id="about-heading">
          ...
          >
            Tentang Kami & <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-amber-500 to-teal-600">Visi Misi Perusahaan</span>
          </motion.h2>
        ...
        >
          <div className="border-b border-slate-100 pb-5">
            ...
            <h3 className="font-display font-black text-2xl sm:text-3xl text-[#0f172a] uppercase tracking-tight">
              PT. GENERASI BARU ARAKA <span className="text-amber-600">(Araka Trans)</span>
            </h3>
          ...
          <div className="space-y-4 text-slate-700 font-sans text-sm sm:text-base leading-relaxed font-medium">
            <p>
              <strong className="text-[#0f172a] font-bold">PT. Generasi Baru Araka</strong> merupakan perusahaan yang bergerak di bidang jasa rental mobil dan transportasi. Kami menyediakan berbagai pilihan kendaraan yang dapat disesuaikan dengan kebutuhan perjalanan, mulai dari perjalanan pribadi hingga kebutuhan transportasi rombongan.
            </p>
            <p>
              Didukung oleh pilihan armada seperti <strong className="text-amber-600 font-bold">Hiace, Elf, Bus Medium, hingga Alphard</strong>, kami siap menjadi partner perjalanan Anda untuk berbagai keperluan, seperti wisata, perjalanan keluarga, perjalanan bisnis, acara perusahaan, gathering, kunjungan, hingga kebutuhan transportasi lainnya.
            </p>
            <p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
            <div className="p-4 rounded-2xl bg-amber-50/60 border border-amber-100 flex items-start gap-3">
              ...
              <div>
                <span className="font-display font-bold text-xs uppercase text-[#0f172a] block">Pelayanan Profesional</span>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3">
              ...
              <div>
                <span className="font-display font-bold text-xs uppercase text-[#0f172a] block">Armada Lengkap</span>
                <span className="text-[11px] text-slate-600 font-medium block mt-0.5">MPV, Hiace, Elf, Bus & Alphard</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="border-b border-slate-100 pb-5">
            ...
            <h3 className="font-display font-black text-2xl sm:text-3xl text-[#0f172a] uppercase tracking-tight">
              Visi & Misi <span className="text-amber-600">Araka Trans</span>
            </h3>
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gradient-to-br from-amber-50/70 via-slate-50 to-white border-l-4 border-amber-500 p-5 sm:p-6 rounded-r-2xl border-y border-r border-slate-200/80 shadow-xs">
              <p className="font-sans text-base sm:text-lg text-slate-800 leading-relaxed font-bold">
            ...
            <div className="space-y-3">
              {missions.map((misi, idx) => (
                <div key={idx} className="flex items-start gap-3.5 p-4 rounded-2xl bg-slate-50 border border-slate-200/80 hover:border-amber-300 transition-colors">
                  <span className="w-7 h-7 rounded-full bg-amber-500 text-white font-extrabold text-xs flex items-center justify-center shrink-0 mt-0.5 shadow-sm">
                    {idx + 1}
                  </span>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            ...
            <div className="space-y-3 font-sans text-sm text-slate-300">
              <div className="flex items-center gap-3">
                <span className="w-5 h-5 rounded-full bg-amber-500 text-white font-bold text-xs flex items-center justify-center shrink-0">IG</span>
                <div>
                  <strong className="text-white block font-bold">Instagram:</strong>
                  <a href="https://instagram.com/Arakatrans_classytour" target="_blank" rel="noreferrer" className="text-teal-400 font-bold hover:underline">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="https://facebook.com/Arakatrans" target="_blank" rel="noreferrer" className="text-teal-400 font-bold hover:underline">
                    @Arakatrans
                  </a>
                </div>
              </div>
