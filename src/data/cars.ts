...
export const HIACE_VARIANTS: Car[] = [
  {
    ...
    interiorImage: '/hiace_commuter_tv_console.jpg',
    interiorSecondaryImage: '/hiace_commuter_trunk.jpg',
  ...
  },
  {
    ...
    videoUrl: '/WhatsApp Video 2026-08-12 at 15.03.38.mp4',
    seats: 9,
    transmission: 'Manual/Matic',
    fuel: 'Diesel',
    includeList: [
...
export const CARS: Car[] = [
  ...
  },
  {
    ...
    pricePerDay: 2000000,
    priceDisplay: 'Mulai Rp 2.000.000 / hari',
    image: '/neo_grand_tour_cutout.png',
